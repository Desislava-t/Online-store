<div class="container">
    ...
    <div class="container mt-5">
        ...
        <div class="btn-group center-btn-our-products" role="group" aria-label="Basic example">
            <button type="button" class="btn btn-our-products" aria-label="btn our products"><span>Party</span></button>
            <button type="button" class="btn btn-our-products" aria-label="btn our products"><span>Christmas</span>
            </button>
            <button type="button" class="btn btn-our-products" aria-label="btn our products"><span>Prom</span></button>
            <button type="button" class="btn btn-our-products" aria-label="btn our products"><span>Black friday</span>
            </button>
        </div>
    </div>
            ...
            <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="btn-center_add-view">
                    ...
                    <a href="{{route('view-product')}}" target="_blank" aria-label="view-product link">
                        <button class="btn" title="View" aria-label="view product btn"><i class="far fa-eye"></i>
                        </button>
                    </a>
                </div>
