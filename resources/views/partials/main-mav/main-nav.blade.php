    ...
    <div class="pos-f-t">
        ...
        <div class="collapse" id="navbarToggleExternalContent">
            <div class="bg-white p-4">
                ...
                <a href="about-us" class="nav-link hover-effect" aria-label="Your categories">
                    About us
                </a>
                <a href="blog" class="nav-link hover-effect" aria-label="Your categories">
                    Blog
                </a>
            </div>
        </div>
