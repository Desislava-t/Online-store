<div class="container container-mt">
    ...
    <div class="p-5 text-center">
        ...
        <a href="{{ route('accessories-sunglasses') }}"
           class="text-decoration-none hover-effect" aria-label="accessories-sunglasses">
    ...
    <div class="row">
        ...
        <!--Feature product-->
            ...
            <div>
                ...
                <a href="#Feature products" class="text-decoration-none hover-effect" aria-label="Feature products">
                    ...
                    <div class="col-sm-4">
                        <div class="card border-0">
                            <div class="img-hover-zoom">
                                <img src="{{ $product->imageNightlife }}" alt="img product faker" class="w-100">
                            </div>
                            <div class="card-body">
