<template>
    ...
    <footer class="page-footer font-small bg-dark text-white pt-5">
        ...
        <div class="container text-center text-md-left">
            ...
            <div class="row">
                ...
                <div class="col-md-2 ml-1 mr-1">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a class="text-white" href="#" aria-label="addres">
                                <i class="fas fa-map-marker-alt"></i>Away
            ...
            <div class="row">
                ...
                <div class="col ml-1 mr-1">
                    ...
                    <!-- Links -->
                    <h5 class="font-weight-bold text-uppercase mt-3 mb-4 text-center">Bulletin</h5>

                    <form action="./api/subscribe" method="POST" @submit.prevent="subscribeUser()"
                          enctype="multipart/form-data">

                        <div class="form-group">
                            <label for="inputEmail1" class="text-center d-block">Email address</label>
                        ...
                        <button type="submit" class="btn btn-color btn-position">
                            Subscribe
                        </button>
                    </form>
                    ...
                    <div class="form-group">
                        ...
                        <div v-if="hasSuccess" class="alert alert-success alert-dismissible fade show" role="alert">
        ...
        <ul class="list-unstyled list-inline text-center py-2">
            ...
            <li class="list-inline-item">
                <a href="./register" class="btn btn-color" aria-label="register btn btn-color">Register!</a>
            </li>
        </ul>
        <!-- Call to action -->
